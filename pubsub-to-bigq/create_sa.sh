...
gcloud iam service-accounts delete data-flow-sa@scraper-vx3.iam.gserviceaccount.com
...
gcloud iam service-accounts keys create data-flow-sa.json --iam-account=data-flow-sa@scraper-vx3.iam.gserviceaccount.com
